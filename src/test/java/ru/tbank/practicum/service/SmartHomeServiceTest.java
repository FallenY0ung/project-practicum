...
class SmartHomeServiceTest {
    ...
    void shouldApplyWeatherRuleToRadiator() {
        ...
        RadiatorRule narrowRule = createRadiatorRule(
                10L,
                "0",
                "10",
                "22"
        ...
        RadiatorRule wideRule = createRadiatorRule(
                11L,
                "0",
                "20",
                "24"
        ...
        when(weatherService.getLatest()).thenReturn(weather);
        when(radiatorRuleService.getActiveRulesByRadiatorId(radiatorId))
                .thenReturn(List.of(wideRule, narrowRule));
        ...
        verify(radiatorService).updateTemperature(
                radiatorId,
                new BigDecimal("22"),
    ...
    void shouldApplyScheduleToBlinds() {
        ...
        Schedule activeSchedule = createSchedule(
                blindsId,
                LocalTime.MIN,
                LocalTime.MAX
        );
        ...
        verify(blindsService).updateState(
                blindsId,
                BlindsState.OPEN,
